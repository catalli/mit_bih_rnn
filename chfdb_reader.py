...
output_path = ''.join([script_path, '/chfdb_delight.pkl'])
print("Reading data from ",dl_path)
wfdb.dldatabase("chfdb", dl_path)
file_names = []
...
type_quotas = [3000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3000]

test_quotas = [1500,1500,1500,1500,1500,1500,1500,1500,15000,1500,1500,1500,1500,1500,1500]
for f in file_names:
	record = wfdb.rdsamp(f)
	annotation = wfdb.rdann(f, 'ecg')
